...
const Hero = () => {
  ...
  useEffect(() => {
    document.querySelectorAll('#Visual > g').forEach((e) => {
      let character = e.querySelector('g path, g polyline');

      if (character) {
        const totalLength = character.getTotalLength();
        character.style.strokeDasharray = totalLength + 'px';
        character.style.strokeDashoffset = totalLength + 'px';
  ...
  return (
    <section id='home' className='h-screen w-full flex justify-start items-center px-[5vw] bg-zinc-300'>
      <div className="text flex flex-col justify-center items-start w-full lg:pt-[10vw]">
        <div style={{ perspective: '1000px' }} className="flex overflow-hidden gap-[2vw]">
          <h1 className='text-[10vw] leading-[10vw]'>Creative</h1>
          <h1 className='text-[10vw] leading-[10vw]'>Frontend</h1>
        </div>
        <div style={{ perspective: '1000px' }} className="flex overflow-hidden items-center">
          <svg className='max-sm:h-[8vh] w-[20vw] m-[0vw_1vw_0vw_7vw]' id="Visual"
            ...
            <g id="dot">
              <g clipPath="url(#clip-path)">
                <path id="dot_path" d="M235.53,91.06s-3.65-21.72,18.78-61" transform="translate(31.09 32.56)" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="34" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></path>
              </g>
            </g>
            <g id="l">
              <g clipPath="url(#clip-path-2)">
                <polyline id="l_path" points="820.4 302.62 755.9 334.12 843.9 39.12 784.4 63.62" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="42" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></polyline>
              </g>
            </g>
            <g id="i">
              <g clipPath="url(#clip-path-3)">
                <polyline id="i_path" points="207.9 165.12 254.9 147.12 201.9 329.12 262.9 299.12" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="42" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></polyline>
              </g>
            </g>
            <g id="a">
              <g clipPath="url(#clip-path-4)">
                <path id="a_path" d="M671.81,121.56l-104,173s-28-39-5-98,114.34-107,123.5-80.5c9,26-49.5,180.5-49.5,180.5l67.5-35.5" transform="translate(31.09 32.56)" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="42" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></path>
              </g>
            </g>
            <g id="u">
              <g clipPath="url(#clip-path-5)">
                <path id="u_path" d="M371.81,132.56l64-31-68,200,34-7s80-120,109-181l15-4-55,187,60-33" transform="translate(31.09 32.56)" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="42" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></path>
              </g>
            </g>
            <g id="s">
              <g clipPath="url(#clip-path-6)">
                <path id="s_path" d="M232.31,261.06s20.5,20.5,32.5,22.5,57-6,69-39-53-64-53-82c0,0,19.5-74.5,97.5-41.5" transform="translate(31.09 32.56)" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="42" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></path>
              </g>
            </g>
            <g id="V">
              <g clipPath="url(#clip-path-7)"><path id="v_path" d="M21.31,59.06l71-32-5,26L26,246.56l-8.69,57.5s85-71,122-114c28-34,100.21-133.4,12-171" transform="translate(31.09 32.56)" fill="none" stroke="#1e40af" strokeMiterlimit="10" strokeWidth="70" style={{ strokeDashoffset: 0, strokeDasharray: 0 }}></path>
              </g>
            </g>
          </svg>
          <h1 className='text-[10vw] leading-[10vw]'>Developer</h1>
        </div>
        <div className="flex justify-center items-center pt-[2vw]">
          <p className='font-light leading-none lg:text-sm max-sm:text-xs lg:text-center lg:w-[80%]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis odio dolor qui nobis animi omnis numquam cum exercitationem temporibus aut. Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto distinctio expedita ut libero! Quasi aliquam libero blanditiis! Inventore, quibusdam eaque.</p>
        </div>
        <div className="flex lg:justify-center items-center pt-[2vw] w-full">
          <button className='px-[2vw] py-[.7vw] bg-blue-800 text-zinc-300 rounded-full max-sm:text-xs relative before:content-[""] before:h-full before:w-full before:bg-zinc-300 before:left-0 before:absolute before:top-[100%] before:rounded-[50%] hover:before:top-0 before:duration-500 hover:before:rounded-[0] overflow-hidden before:z-[-1] z-[1] hover:text-zinc-800 hover:shadow-[0px_2px_4px_0px_black]'>Explore</button>
        </div>
      </div>
    </section>
  )
